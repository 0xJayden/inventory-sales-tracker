        ...
        Container::new(
            ...
            .spacing(8)
                ...
                .push(
                    ...
                    .on_input(|input| AppMessage::Manufacture(ManufactureMessage::Query(input))),
                    )
                .push(
                    Container::new(
                        Column::new()
                            ...
                            .extend(
                                ...
                                .map(|product| {
                                    Container::new(
                                        ...
                                        .push(close_button(AppMessage::Manufacture(ManufactureMessage::RemoveProduct(product.product_id)))
                                            ))
                                                .style(table_row_style())
                                                .into()
                                }),
    ...
    pub fn view(&self) -> Element<AppMessage> {
        layout(
            ...
            .push(
                Row::new()
                .push(
                    add_button("Add Manufacture", AppMessage::Manufacture(
                            ManufactureMessage::ShowAddManufacture,
                            ))
                    )
                .padding(12),
