    ...
    pub fn view(&self) -> Element<AppMessage> {
        layout(
            Column::new()
                ...
                .push(Text::new("Reps".to_string()).size(24))
                .push(
                    Row::new()
                        .push(add_button(
                            "Add Rep",
                            AppMessage::Rep(RepMessage::ShowAddRep),
                        ))
                        .padding(12),
                )
                ...
                .push(
                    Container::new(table_header(&["Name", "Percentage"]).push(Scrollable::new(
                        Column::new().extend(self.reps.iter().map(|rep| {
                            Button::new(
                                Container::new(
                                    Row::new()
                                        .padding(10)
                    ...
                    .push(
                        Column::new()
                            ...
                            .push(text_input_column(
                                ...
                                |input| AppMessage::Rep(RepMessage::NameInput(input, true)),
                                Some(AppMessage::Rep(RepMessage::Submit(true))),
                            ))
                            .push(text_input_column(
                                "Percentage",
                                &self.rep_to_edit.percentage.to_string(),
                                |input| AppMessage::Rep(RepMessage::PercentageInput(input, true)),
                                Some(AppMessage::Rep(RepMessage::Submit(true))),
                            ))
                            .push(
                                Row::new()
                    ...
                    .push(
                        Column::new()
                            ...
                            .push(text_input_column(
                                ...
                                |input| AppMessage::Rep(RepMessage::NameInput(input, false)),
                                None,
                            ))
                            .push(text_input_column(
                                "Percentage",
                                &self.rep_to_add.percentage.to_string(),
                                |input| AppMessage::Rep(RepMessage::PercentageInput(input, false)),
                                Some(AppMessage::Rep(RepMessage::Submit(false))),
                            ))
                            .push(
                                Row::new().push(
                                    Button::new("Submit")
                                        .on_press(AppMessage::Rep(RepMessage::Submit(false)))
                                        .style(CustomMainButtonStyle),
                                ),
                            )
                            .padding(24),
